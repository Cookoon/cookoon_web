# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# THESE TESTS ARE FROM DELETED PRO::NAMESPACE 
# REARRANGE THEM TO TEST THE ACTUAL PRICE COMPUTER
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#     let(:reservation) { create(:reservation, cookoon: cookoon, duration: 5, people_count: 5) }
#     let!(:service) { create(:service, reservation: reservation) }
